...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    constructor(private element: ElementRef, private service: BasicRestService, private router:Router) {
    ...
    login() {
        this.service.post(environment.BASESERVICE + environment.USER_LOGIN, false, this.authontication).subscribe(data => {
            ...
            swal("Invalid login", "username or password incorrect", "warning");
        })
    }
}
